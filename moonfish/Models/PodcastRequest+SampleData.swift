    ...
    static var sampleData: [PodcastRequest] {
        ...
        return [
            ...
            PodcastRequest(
                ...
                createdDate: Date(timeIntervalSinceNow: -86400 * 3), // 3 days ago
            ...
            PodcastRequest(
                ...
                progressValue: 1.0,
                configuration: quantumConfig,
                createdDate: Date(timeIntervalSinceNow: -86400 * 5), // 5 days ago
                ...
                completedPodcast: Podcast(
                    ...
                    duration: 305,
                    createdDate: Date(timeIntervalSinceNow: -86400 * 5 + 3600), // Podcast created slightly after request
                    configuration: quantumConfig
                )
            ),
            ...
            PodcastRequest(
                ...
                createdDate: Date(timeIntervalSinceNow: -3600 * 2), // 2 hours ago
                // title defaults to "Untitled"
                step: .compose
            ),
            ...
            PodcastRequest(
                ...
                progressValue: 1.0,
                configuration: gardeningConfig,
                createdDate: Date(timeIntervalSinceNow: -86400 * 2), // 2 days ago
                ...
                completedPodcast: Podcast(
                    ...
                    duration: 950,
                    createdDate: Date(timeIntervalSinceNow: -86400 * 2 + (3600*2)), // Podcast created slightly after request
                    configuration: gardeningConfig
                )
            ),
            ...
            PodcastRequest(
                id: UUID(),
                configuration: aiEthicsConfig,
                createdDate: Date(timeIntervalSinceNow: -60 * 10), // 10 minutes ago
